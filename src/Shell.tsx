...
class ShellContainer extends React.Component<Props> implements ShellFunctions {
    ...
    render() {
        ...
        const camButtonClassName = classList(
            'wc-cam',
            this.props.cameraRecording && 'active',
            !this.props.cameraRecording && 'inactive'
        );
...
export const Shell = connect(
    (state: ChatState) => ({
        ...
        cameraRecording : state.shell.cameraRecording
    }), {
        // passed down to ShellContainer
        ...
        stopCamera:  () => ({ type: 'Camera_Stopping' }),
        startCamera:  () => ({ type: 'Camera_Starting' }),
        // only used to create helper functions below
        sendMessage,
        sendFiles
        ...
        cameraRecording : stateProps.cameraRecording,
        // from dispatchProps
        ...
        startCamera:  () => dispatchProps.startCamera(),
        stopCamera:  () => dispatchProps.stopCamera()
    }), {
        withRef: true
    }
)(ShellContainer);
